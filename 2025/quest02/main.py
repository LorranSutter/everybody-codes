...
def plot_grid(grid: List[List[str]]):
    ...
    ax = plt.gca()
    ax.scatter(all_points_x, all_points_y, color='grey', marker='o', s=1, label='All Grid Points')
    ax.scatter(specific_points_x, specific_points_y, color='red', marker='o', s=10, label='Specific Points', zorder=10)
